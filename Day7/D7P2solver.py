...
used_space = sum(file_dict.values())
current_free = total_space - used_space
print(current_free)
space_to_free = needed_space - current_free
print(space_to_free)
best_sum = used_space
...
for path in dir_set:
    ...
    if path_sum >= space_to_free and path_sum <= best_sum:
        best_sum = path_sum
